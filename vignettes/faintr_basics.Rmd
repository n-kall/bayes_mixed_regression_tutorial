...
devtools::install_github(
  "michael-franke/bayes_mixed_regression_tutorial/faintr",
...
against female speakers in polite contexts, we can do this:

```{r}
faintr::compare_cells(
  model = m_dummy,
...
We could also compare male and female speakers at each context using
the `by` argument.
